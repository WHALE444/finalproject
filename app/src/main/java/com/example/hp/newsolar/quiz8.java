...
public class quiz8 extends AppCompatActivity {
    ...
    Button.OnClickListener listener = new Button.OnClickListener() {
        public void onClick(View v) {
            Intent intent = new Intent(quiz8.this, neptune.class);
    ...
    Button.OnClickListener listener1 = new Button.OnClickListener() {
        public void onClick(View v) {
            ...
            Toast toastCenter = Toast.makeText(getApplicationContext(),"you sure?",Toast.LENGTH_LONG);
    ...
    Button.OnClickListener listener2 = new Button.OnClickListener() {
        public void onClick(View v) {
            Toast toastCenter = Toast.makeText(getApplicationContext(),"Correct!",Toast.LENGTH_LONG);
