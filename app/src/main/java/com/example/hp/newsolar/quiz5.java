...
public class quiz5 extends AppCompatActivity {
    ...
    Button.OnClickListener listener = new Button.OnClickListener() {
        public void onClick(View v) {
            Intent intent = new Intent(quiz5.this, jupiter.class);
    ...
    Button.OnClickListener listener1 = new Button.OnClickListener() {
        public void onClick(View v) {
            ...
            Toast toastCenter = Toast.makeText(getApplicationContext(),"um..try to think clearly!",Toast.LENGTH_LONG);
    ...
    Button.OnClickListener listener2 = new Button.OnClickListener() {
        public void onClick(View v) {
            Toast toastCenter = Toast.makeText(getApplicationContext(),"Excellent!",Toast.LENGTH_LONG);
